...
class_declaration:
    opt_final_class CLASS ID extends LBRACE decls RBRACE
    ;
...
decl_suffix:
    SEMICOLON { /* This was a variable declaration */ }
    | LPAREN param_list RPAREN var_expr_block { /* This was a method declaration */ }
    ;
